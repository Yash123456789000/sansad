...
const scheduleDetails = [
  {
    id: 1,
    eventName: "Round 1 | Quiz Assessment",
    date: "FEB 17",
    description:
  ...
  },
  {
    ...
    date: "FEB 17 - FEB 28",
    description:
      "The top 300 participants from Round 1 have been shortlisted for Round 2, and the registration link will be activated exclusively for them. To confirm participation, participants must complete the registration process and pay a ₹999 fee, which covers 3-day accommodation from 7-9th March at IIT Kharagpur during the offline event and Megalith Fest. However, only the first 80 participants will advance to the next round on a First Come, First Serve basis. Payments will be processed via Unstop in a Private Mode hosted competition page. ",
    image: image,
    venue: "ON UNSTOP WEBSITE",
    time: "11:59 PM to 11:59 PM",
    whatsapp: "",
    loc: "",
  },
  {
