    ...
    <>
      <footer className="flex flex-col-reverse md:flex-row bg-[url('/assets/landingPage/footer/bg.png')] bg-cover items-center gap-10 md:gap-0 px-5 sm:px-10 ms:px-20 justify-between py-5">
        <div className="flex gap-10">
          ...
          <div className="uppercase flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              <Link
                href={"https://www.instagram.com/ppgs.iitkgp/"}
                target="blank"
              ...
              <Link
                href={"https://twitter.com/ppgs_iitkgp"}
                target="blank"
                className="flex gap-2 items-center text-2xl"
              >
                <FaSquareXTwitter />
              ...
              <Link
                href={"https://www.linkedin.com/company/civil-services-club-iitkgp/"}
                target="blank"
                className="flex gap-2 items-center text-2xl"
              >
                <FaLinkedin />
              ...
              <Link
                href={"https://www.facebook.com/ppgs.iitkgp"}
                target="blank"
                className="flex gap-2 items-center text-2xl"
              >
                <FaSquareFacebook />
        ...
        <div className="flex flex-col gap-4 text-center">
          <div>
            <h1 className="text-5xl sm:text-7xl font-bold">PUBLIC POLICY AND GOVERNANCE SOCIETY</h1>
          ...
          <div>
            <div className="flex flex-col text-sm gap-1">
              ...
              <Link
                className="flex items-center gap-2 justify-center"
                href={"mailto:https://ppgsiitkgp.in/"}
              >
                <span>
                  <IoMdMail />
                </span>
